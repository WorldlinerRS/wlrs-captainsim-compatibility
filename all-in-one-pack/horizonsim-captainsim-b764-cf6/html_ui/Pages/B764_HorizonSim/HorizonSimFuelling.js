...
class HorizonSimFueling {
    ...
    update(_deltaTime) {
        ...
        const refuelStartedByUser = SimVar.GetSimVarValue("L:B764_FUELING_STARTED", "Bool");
        const isOnGround = SimVar.GetSimVarValue("SIM ON GROUND", "Bool");

        const refuelingRateIndex = WTDataStore.get("B764 REFUEL RATE INDEX", 0);
        let refuelingRate;
        ...
        const main1TargetSimVar = SimVar.GetSimVarValue("L:B764_FUEL_TANK_LEFT_MAIN_QUANTITY_REQUEST", "Gallons");
        const main2TargetSimVar = SimVar.GetSimVarValue("L:B764_FUEL_TANK_RIGHT_MAIN_QUANTITY_REQUEST", "Gallons");
        const centerTargetSimVar = SimVar.GetSimVarValue("L:B764_FUEL_TANK_CENTER_QUANTITY_REQUEST", "Gallons");
        ...
        if (refuelingRate == "INSTANT") {
            ...
            SimVar.SetSimVarValue("L:B764_FUELING_STARTED", "Bool", false);
            return;
        }
