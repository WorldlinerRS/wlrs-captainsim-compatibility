class HorizonSimJettison {
    constructor() {
        ...
        this.knobPosToAction = {
            ...
            1: (knobMoved) => {
                ...
                SimVar.SetSimVarValue("L:B764_FUEL_TO_REMAIN", "TYPE_FLOAT64", this.mlwFuel);
            ...
            0: (knobMoved) => {
                if (knobMoved) {
                    ...
                    this.jettFuelTarget = SimVar.GetSimVarValue("L:B764_FUEL_TO_REMAIN", "TYPE_FLOAT64");
                }
                ...
                SimVar.SetSimVarValue("L:B764_FUEL_TO_REMAIN", "TYPE_FLOAT64", this.jettFuelTarget);
    ...
    update() {
        ...
        var newKnobPos = parseInt(SimVar.GetSimVarValue("L:764_JETTISON_KNOB_POS", "Enum"));
        ...
        SimVar.SetSimVarValue("L:B764_FUEL_JETTISON_ACTIVE_L", "Enum", publishL);
        SimVar.SetSimVarValue("L:B764_FUEL_JETTISON_ACTIVE_R", "Enum", publishR);
    }
    ...
    checkFuelPumpsAndJettison() {
        ...
        var main1Lim;
        if (SimVar.GetSimVarValue("FUELSYSTEM PUMP ACTIVE:3", "Bool") && SimVar.GetSimVarValue("FUELSYSTEM PUMP ACTIVE:4", "Bool")) {
        ...
        var main2Lim;
        if (SimVar.GetSimVarValue("FUELSYSTEM PUMP ACTIVE:5", "Bool") && SimVar.GetSimVarValue("FUELSYSTEM PUMP ACTIVE:6", "Bool")) {
            main2Lim = this.TANK_LOWER_LIMS.MAIN_2;
        } else {
            main2Lim = 10000;
        }

        remainingFlow = jettisonStage(["FUEL TANK LEFT MAIN QUANTITY", "FUEL TANK RIGHT MAIN QUANTITY"], [main1Lim, main2Lim], remainingFlow);
        if (!remainingFlow) return maxJettisonFlow;
    ...
    runJettison(jettType) {
        ...
        if (flowRatePerMin <= 0.000001) {
            SimVar.SetSimVarValue("L:B764_JETTISON_MIN_REMAINING", "TYPE_FLOAT64", 999);
            return;
        }
        ...
        SimVar.SetSimVarValue("L:B764_JETTISON_MIN_REMAINING", "TYPE_FLOAT64", Math.min(minRemaining, 999));
