class HorizonSimADIRU {
    ...
    update(electricityIsAvail) {
        ...
        SimVar.SetSimVarValue("L:B764_Plane_Landed", "Bool", this.hasLanded);
        SimVar.SetSimVarValue("L:B764_Plane_TookOff", "Bool", this.hasTO);
        ...
        const adiruButtonState = SimVar.GetSimVarValue("L:B764_ADIRU_BUTTON_STATE", "Bool");
        const adiruState = SimVar.GetSimVarValue("L:B764_ADIRU_STATE", "Enum");
        ...
        if (onGround && !adiruButtonState) {
            if (this.hasLanded && !enginesRunning) {
                SimVar.SetSimVarValue("L:B764_ADIRU_STATE", "Enum", 0);
                this.resetInitalTimer = 30;
            }
            ...
            SimVar.SetSimVarValue("L:B764_ADIRU_STATE", "Enum", 2);
            ...
            if (this.resetInitalTimer > 0) {
                ...
                SimVar.SetSimVarValue("L:B764_ADIRU_STATE", "Enum", 1);
            }
        }
        ...
        SimVar.SetSimVarValue("L:B764_ADIRU_TIME_LEFT", "Enum", this.adiruTimer);
    }
}
