class teeveeAnimHanlder {
    ...
    init() {
        /*
        this.pilotWindowLeft = SimVar.GetSimVarValue("L:cs764_pilot_wnd_l", "bool");
        this.pilotWindowRight = SimVar.GetSimVarValue("L:cs764_pilot_wnd_r", "bool");
        this.fwdAccessDoor = SimVar.GetSimVarValue("L:cs764_anim_ctrl_fwd_acc_door", "bool");
        this.pitotPlugs = SimVar.GetSimVarValue("L:cs764_anim_ctrl_plugs", "bool");
        this.fwdOutflowValve = SimVar.GetSimVarValue("L:cs764_anim_ctrl_fwd_outf_val", "bool");
        this.entryDoorL1 = SimVar.GetSimVarValue("L:cs764_anim_ctrl_l_door_1", "bool");
        this.entryDoorL2 = SimVar.GetSimVarValue("L:cs764_anim_ctrl_l_door_2", "bool");
        this.entryDoorLEmer = SimVar.GetSimVarValue("L:cs764_anim_ctrl_l_emer_door", "bool");
        this.entryDoorL3 = SimVar.GetSimVarValue("L:cs764_anim_ctrl_l_door_3", "bool");
        this.entryDoorL4 = SimVar.GetSimVarValue("L:cs764_anim_ctrl_l_door_4", "bool");
        this.entryDoorR1 = SimVar.GetSimVarValue("L:cs764_anim_ctrl_r_door_1", "bool");
        this.entryDoorR2 = SimVar.GetSimVarValue("L:cs764_anim_ctrl_r_door_2", "bool");
        this.entryDoorREmer = SimVar.GetSimVarValue("L:cs764_anim_ctrl_r_emer_door", "bool");
        this.entryDoorR3 = SimVar.GetSimVarValue("L:cs764_anim_ctrl_r_door_3", "bool");
        this.entryDoorR4 = SimVar.GetSimVarValue("L:cs764_anim_ctrl_r_door_4", "bool");
        this.greaDoors = SimVar.GetSimVarValue("L:cs764_anim_ctrl_fwd_acc_door", "bool");

        this.epHatch = SimVar.GetSimVarValue("L:L:cs764_anim_ctrl_ep_hatch", "bool");
        */
    }
    update() { 
        ...
        if (reverserPercent1 > 50) {
            ...
            SimVar.SetSimVarValue("L:B764_ENGINE_REVERSER:1", "Enum", position1);
        }
        else {
            SimVar.SetSimVarValue("L:B764_ENGINE_REVERSER:1", "Enum", 0);
        }
        if (reverserPercent2 > 50) {
            let position2 = (reverserPercent2 - 50) * 2;
            SimVar.SetSimVarValue("L:B764_ENGINE_REVERSER:2", "Enum", position2);
        }
        else {
            SimVar.SetSimVarValue("L:B764_ENGINE_REVERSER:2", "Enum", 0);
        }
        ...
        if (SimVar.GetSimVarValue("L:XMLVAR_APU_StarterKnob_Pos", "Number") === 1 || SimVar.GetSimVarValue("APU PCT STARTER", "percent") > 1) {
            SimVar.SetSimVarValue("L:cs764_anim_ctrl_apu_intake", "Bool", true);
        }
        else {
            SimVar.SetSimVarValue("L:cs764_anim_ctrl_apu_intake", "Bool", false);
        }
        ...
        {
            SimVar.SetSimVarValue("L:cs764_anim_ctrl_ep_hatch", "Bool", true);
        }
        else {
            SimVar.SetSimVarValue("L:cs764_anim_ctrl_ep_hatch", "Bool", false);
        }
        //WX radar
        if (SimVar.GetSimVarValue("L:BTN_WX_ACTIVE", "Bool")) {
            SimVar.SetSimVarValue("L:cs764_anim_ctrl_radar", "Bool", true);
        }
        else {
            SimVar.SetSimVarValue("L:cs764_anim_ctrl_radar", "Bool", false);
        }*/
