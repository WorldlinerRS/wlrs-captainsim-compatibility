class BaseAirliners extends NavSystem {
    ...
    updateMachTransition() {
        ...
        let isMachActive = Simplane.getAutoPilotMachModeActive();   //sometimes flash
                ...
                switch (this.highlightItem.type) {
                    ...
                    case PopupMenu_ItemType.RADIO_RANGE:
                        if (this.highlightItem.rangeVal > this.highlightItem.rangeMin) {
                            ...
                            this.highlightItem.rangeElem.textContent = fastToFixed(this.highlightItem.rangeVal, this.highlightItem.rangeDecimals);
                            this.onChanged(this.highlightItem);
        ...
        endSection() {
            ...
            for (let i = 0; i < this.section.items.length; i++) {
                ...
                if (item.rangeElem) {
                    ...
                    item.rangeElem.textContent = fastToFixed(item.rangeVal, item.rangeDecimals);
                    changed = true;
                }
